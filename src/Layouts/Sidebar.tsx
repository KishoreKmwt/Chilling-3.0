  ...
  return (
    ...
    <div data-simplebar className="h-100">
        ...
        <li>
                    ...
                    <NavLink to={"/teachers"} className="waves-effect">
                        <i className="bx bx-file"></i>
                        <span key="t-dashboards">Teacher's List</span>
                    </NavLink>

                    <NavLink to={"/students"} className="waves-effect">
                        <i className="bx bx-layout"></i>
                        <span key="t-dashboards">Student's List</span>
                    </NavLink>
...
{/* 
                <li>
                                ...
                                <ul className="sub-menu" aria-expanded="true">
                                            <li><Link to={""} key="t-light-sidebar">Faqs List</Link></li>
                                        </ul>
                                    </li> 
                    ...
                    <NavLink to={""} className="waves-effect">
                        <i className="bx bx-file"></i>
                        <span key="t-dashboards">CMS Pages</span>
                    </NavLink>
                </li> */}
